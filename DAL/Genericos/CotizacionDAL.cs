...
WHERE sc.idCotizacion = @id;";
            ...
            using (var cmd = new SqlCommand(sql, conn) { CommandType = CommandType.Text })
            {
                ...
                try
                {
                    ...
                    using (var rdr = cmd.ExecuteReader())
                    {
                        ...
                        if (ctz == null)
                        {
                            ...
                            db.ExecuteScalarAndLog("SELECT 1", null, TblCotizacion, PkCotizacion,
                                BE.Audit.AuditEvents.ConsultaCotizacionDetalle, "Detalle inexistente Id=" + idCotizacion, false);
                            return null;
                        }
                    ...
                    db.ExecuteScalarAndLog("SELECT 1", null, TblCotizacion, PkCotizacion,
                        BE.Audit.AuditEvents.ConsultaCotizacionDetalle, "Detalle Id=" + idCotizacion, false);
                }
                catch (Exception ex)
                {
...
SELECT CAST(SCOPE_IDENTITY() AS int);";
            ...
            if (newId != null && newId != DBNull.Value)
            {
                ...
                db.RefreshRowDvAndTableDvv(TblCotizacion, PkCotizacion, obj.IdCotizacion, false);
            }
        }
...
WHERE " + PkCotizacion + @" = @id;";
            ...
            db.ExecuteNonQueryAndLog(
                ...
                TblCotizacion, PkCotizacion, obj.IdCotizacion,
